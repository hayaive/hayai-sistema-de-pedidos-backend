...
| `products` (catálogo) | Sí, con reservas | `rev` | Parche con LWW **por campo**. `stock` **no es escribible**: sólo cambia por movimiento. `code` repetido ⇒ recodificación + `idMap`; código retirado ⇒ rechazo |
